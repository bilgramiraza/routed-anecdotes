...
import { notifyWithTimeout, useNotificationDispatch, useNotificationValue } from './reducers/NotificationContext';
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    navigate('/');
    notifyWithTimeout(dispatch, `Anecdote Created: "${anecdote.content}"`);
  }
